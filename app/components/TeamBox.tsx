...
function TeamBox (props: TeamBoxProps) { 
  return (
    <div className='flex flex-col w-[300px] h-[500px] items-center justify-around bg-[#f1f1f1] rounded-2xl m-5 '>
        <div className='flex w-[250px] h-[370px] bg-blue-400 rounded-xl mt-2 justify-center overflow-hidden items-center '>
          <img src={props.imgurl} alt="Image" className='h-full w-full object-cover' />
          </div>
        <div className='flex w-[250px] items-center h-[80px]'>
